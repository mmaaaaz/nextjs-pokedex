const PokemonImage = ({
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden border-r">
      <div
        className="absolute top-24 flex font-mono uppercase select-none flex-col items-center justify-center text-4xl font-bold tracking-widest opacity-100 lg:top-32 lg:text-7xl"
        style={{
          color,
        }}
      >
