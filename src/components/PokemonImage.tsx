...
const PokemonImage = ({ pokemon }: PokemonImageProps) => {
  return (
    <div
      className="relative flex h-full max-h-[70vh] min-h-[50vh] w-full flex-col items-center justify-between overflow-hidden rounded-2xl lg:rounded-r-none rounded-b-none"
      style={{
